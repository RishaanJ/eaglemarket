...
import { EagleShader } from "@/components/ui/eagle-shader";
  ...
  return (
    <div className="app-shell">
      <header className="topbar">
        <a className="wordmark" href="#"><EagleMark /><span>EagleMarket</span></a>
        <nav className="primary-nav" aria-label="Primary navigation">
          <a className="active" href="#markets">Markets</a>
          <a href="#live">Live <span className="live-dot" /></a>
      ...
      <main>
        ...
        <section className="campus-pulse">
          <EagleShader className="pulse-shader" />
          <div className="pulse-copy"><span className="pulse-label">CAMPUS PULSE</span><h2>Which SPW event are you most excited for?</h2><p>This is a community poll, not a prediction market. Vote once to reveal what the school thinks.</p></div>
          <ChoicePoll.Root votes={{ dodgeball: 148, talent: 96, field: 121 }}>
            <ChoicePoll.Option value="dodgeball">Grade dodgeball tournament</ChoicePoll.Option>
            <ChoicePoll.Option value="talent">Student talent show</ChoicePoll.Option>
            <ChoicePoll.Option value="field">Friday field day</ChoicePoll.Option>
            <div className="poll-actions"><ChoicePoll.Footer /><ChoicePoll.Submit /></div>
          </ChoicePoll.Root>
        </section>
      </main>
    </div>
